...
def process_transforms(img,*transformations)
	...
	"""
		View that returns an image transformed according to the query options in the request string.
	...
	# apply necessary/easily applicable transforms according to preset precedence
